                                                                                           ...
                                                                                           const unsigned& flag)
{
 ...
 for (unsigned ipt = 0; ipt < n_intpt; ipt++)
 {
  ...
  this->anisotropic_get_stress(g, G, a, sigma);
 ...
 const unsigned& flag)
{
 ...
 for (unsigned ipt = 0; ipt < n_intpt; ipt++)
 {
  ...
  {
   this->anisotropic_get_stress(g, G, a, sigma_dev, Gup, detG);
  ...
  {
   this->anisotropic_get_stress(g, G, a, sigma_dev, Gup, gen_dil, inv_kappa);
     ...
     for (unsigned i = 0; i < DIM; i++)
     {
      ...
      if (local_eqn >= 0)
      {
       ...
       if (flag > 0)
       {
        ...
        for (unsigned l2 = 0; l < n_solid_pres; l++)
        {
